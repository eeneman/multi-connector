...
...                          encrypted=true
...                          username=surendra.marthala@eeneman.com
...                          password=88SoExR2#GTT/
...                          position=header
...
fetch, 200
    ...
    Fetch Data Product    ${body}
    Integer               response status                                         200
    String                response body @context                                  https://standards.oftrust.net/v2/Context/DataProductOutput/Process/Measure/IndoorAirQuality/
    Object                response body data
    Array                 response body data indoorAirQuality
    Object                response body data indoorAirQuality 0
    String                response body data indoorAirQuality 0 id
    Array                 response body data indoorAirQuality 0 measurements
    Object                response body data indoorAirQuality 0 measurements 0
